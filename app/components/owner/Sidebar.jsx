...
import { LayoutDashboard, ShoppingCart, Package, ListOrdered, LogOut , CreditCard, ShieldCheck} from "lucide-react";

const menuItems = [
  { name: "Dashboard", href: "/owner/dashboard", icon: LayoutDashboard },
  { name: "Store", href: "/owner/stores", icon: ShoppingCart },
  { name: "Manage Order", href: "/owner/order", icon: ShoppingCart },
  { name: "Products", href: "/owner/products", icon: Package },
  { name: "Categories", href: "/owner/categories", icon: ListOrdered },
  { name: "Payment Accounts", href: "/owner/payments", icon: CreditCard },
